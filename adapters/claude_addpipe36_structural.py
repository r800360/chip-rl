...
The action space is exactly one 35-bit boundary mask. The mask represents
an ordered composition of a 36-bit adder. Bit i of the mask inserts a
...
Requirements:
- mask must be between 0x000000 and 0x7ffffffff
