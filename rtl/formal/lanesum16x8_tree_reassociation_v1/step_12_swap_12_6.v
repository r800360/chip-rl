...
wire [9:0] s_0107 = s_0007 + {2'd0,lane_8};
wire [10:0] s_010f = {1'd0,s_0107} + {3'd0,lane_3};
wire [10:0] s_030f = s_010f + {3'd0,lane_9};
wire [10:0] s_031f = s_030f + {3'd0,lane_4};
wire [10:0] s_071f = s_031f + {3'd0,lane_10};
wire [11:0] s_073f = {1'd0,s_071f} + {4'd0,lane_5};
wire [11:0] s_0f3f = s_073f + {4'd0,lane_11};
wire [11:0] s_0f7f = s_0f3f + {4'd0,lane_6};
wire [11:0] s_1f7f = s_0f7f + {4'd0,lane_12};
