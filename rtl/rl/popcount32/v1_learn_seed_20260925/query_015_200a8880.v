...
wire [5:0] pc_2 = 6'd0 + {5'd0, a_i[12]} + {5'd0, a_i[13]} + {5'd0, a_i[14]} + {5'd0, a_i[15]};
wire [5:0] pc_3 = 6'd0 + {5'd0, a_i[16]} + {5'd0, a_i[17]};
wire [5:0] pc_4 = 6'd0 + {5'd0, a_i[18]} + {5'd0, a_i[19]};
wire [5:0] pc_5 = 6'd0 + {5'd0, a_i[20]} + {5'd0, a_i[21]} + {5'd0, a_i[22]} + {5'd0, a_i[23]} + {5'd0, a_i[24]} + {5'd0, a_i[25]} + {5'd0, a_i[26]} + {5'd0, a_i[27]} + {5'd0, a_i[28]} + {5'd0, a_i[29]};
wire [5:0] pc_6 = 6'd0 + {5'd0, a_i[30]} + {5'd0, a_i[31]};
