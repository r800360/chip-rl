...
wire [5:0] blk_3_1;
wire [5:0] blk_3;
assign blk_3_0 = {1'b0, a_i[7:3]} + {1'b0, b_i[7:3]};
assign blk_3_1 = {1'b0, a_i[7:3]} + {1'b0, b_i[7:3]} + {{5{1'b0}}, 1'b1};
assign blk_3 = carry_2 ? blk_3_1 : blk_3_0;
assign sum[7:3] = blk_3[4:0];
wire carry_3;
...
wire [1:0] blk_5_1;
wire [1:0] blk_5;
assign blk_5_0 = {1'b0, a_i[9:9]} + {1'b0, b_i[9:9]};
assign blk_5_1 = {1'b0, a_i[9:9]} + {1'b0, b_i[9:9]} + {{1{1'b0}}, 1'b1};
assign blk_5 = carry_4 ? blk_5_1 : blk_5_0;
assign sum[9:9] = blk_5[0:0];
wire carry_5;
...
wire [1:0] blk_6_1;
wire [1:0] blk_6;
assign blk_6_0 = {1'b0, a_i[10:10]} + {1'b0, b_i[10:10]};
assign blk_6_1 = {1'b0, a_i[10:10]} + {1'b0, b_i[10:10]} + {{1{1'b0}}, 1'b1};
assign blk_6 = carry_5 ? blk_6_1 : blk_6_0;
assign sum[10:10] = blk_6[0:0];
wire carry_6;
...
wire [3:0] blk_7_1;
wire [3:0] blk_7;
assign blk_7_0 = {1'b0, a_i[13:11]} + {1'b0, b_i[13:11]};
assign blk_7_1 = {1'b0, a_i[13:11]} + {1'b0, b_i[13:11]} + {{3{1'b0}}, 1'b1};
assign blk_7 = carry_6 ? blk_7_1 : blk_7_0;
assign sum[13:11] = blk_7[2:0];
wire carry_7;
...
wire [1:0] blk_8_1;
wire [1:0] blk_8;
assign blk_8_0 = {1'b0, a_i[14:14]} + {1'b0, b_i[14:14]};
assign blk_8_1 = {1'b0, a_i[14:14]} + {1'b0, b_i[14:14]} + {{1{1'b0}}, 1'b1};
assign blk_8 = carry_7 ? blk_8_1 : blk_8_0;
assign sum[14:14] = blk_8[0:0];
wire carry_8;
