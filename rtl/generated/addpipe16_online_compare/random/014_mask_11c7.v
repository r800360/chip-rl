...
wire [4:0] blk_3_1;
wire [4:0] blk_3;
assign blk_3_0 = {1'b0, a_i[6:3]} + {1'b0, b_i[6:3]};
assign blk_3_1 = {1'b0, a_i[6:3]} + {1'b0, b_i[6:3]} + {{4{1'b0}}, 1'b1};
assign blk_3 = carry_2 ? blk_3_1 : blk_3_0;
assign sum[6:3] = blk_3[3:0];
wire carry_3;
...
wire [4:0] blk_6_1;
wire [4:0] blk_6;
assign blk_6_0 = {1'b0, a_i[12:9]} + {1'b0, b_i[12:9]};
assign blk_6_1 = {1'b0, a_i[12:9]} + {1'b0, b_i[12:9]} + {{4{1'b0}}, 1'b1};
assign blk_6 = carry_5 ? blk_6_1 : blk_6_0;
assign sum[12:9] = blk_6[3:0];
wire carry_6;
