...
wire [1:0] blk_5_1;
wire [1:0] blk_5;
assign blk_5_0 = {1'b0, a_i[10:10]} + {1'b0, b_i[10:10]};
assign blk_5_1 = {1'b0, a_i[10:10]} + {1'b0, b_i[10:10]} + {{1{1'b0}}, 1'b1};
assign blk_5 = carry_4 ? blk_5_1 : blk_5_0;
assign sum[10:10] = blk_5[0:0];
wire carry_5;
...
wire [4:0] blk_6_1;
wire [4:0] blk_6;
assign blk_6_0 = {1'b0, a_i[14:11]} + {1'b0, b_i[14:11]};
assign blk_6_1 = {1'b0, a_i[14:11]} + {1'b0, b_i[14:11]} + {{4{1'b0}}, 1'b1};
assign blk_6 = carry_5 ? blk_6_1 : blk_6_0;
assign sum[14:11] = blk_6[3:0];
wire carry_6;
