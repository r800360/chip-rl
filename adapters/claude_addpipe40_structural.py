...
The action space is exactly one 39-bit boundary mask. The mask represents
an ordered composition of a 40-bit adder. Bit i of the mask inserts a
...
Requirements:
- mask must be between 0x000000 and 0x7fffffffff
