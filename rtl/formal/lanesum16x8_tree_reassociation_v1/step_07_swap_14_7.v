...
wire [9:0] s_0107 = s_0103 + {2'd0,lane_2};
wire [10:0] s_0307 = {1'd0,s_0107} + {3'd0,lane_9};
wire [10:0] s_030f = s_0307 + {3'd0,lane_3};
wire [10:0] s_070f = s_030f + {3'd0,lane_10};
wire [10:0] s_071f = s_070f + {3'd0,lane_4};
wire [11:0] s_0f1f = {1'd0,s_071f} + {4'd0,lane_11};
wire [11:0] s_0f3f = s_0f1f + {4'd0,lane_5};
wire [11:0] s_1f3f = s_0f3f + {4'd0,lane_12};
wire [11:0] s_1f7f = s_1f3f + {4'd0,lane_6};
wire [11:0] s_3f7f = s_1f7f + {4'd0,lane_13};
wire [11:0] s_3fff = s_3f7f + {4'd0,lane_7};
