...
wire [8:0] s_0c00 = {1'd0,lane_10} + {1'd0,lane_11};
wire [9:0] s_0f00 = {1'd0,s_0300} + {1'd0,s_0c00};
wire [8:0] s_3000 = {1'd0,lane_12} + {1'd0,lane_13};
wire [8:0] s_c000 = {1'd0,lane_14} + {1'd0,lane_15};
wire [9:0] s_f000 = {1'd0,s_3000} + {1'd0,s_c000};
wire [10:0] s_ff00 = {1'd0,s_0f00} + {1'd0,s_f000};
