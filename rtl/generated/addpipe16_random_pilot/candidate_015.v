...
wire [7:0] blk_4_1;
wire [7:0] blk_4;
assign blk_4_0 = {1'b0, a_i[12:6]} + {1'b0, b_i[12:6]};
assign blk_4_1 = {1'b0, a_i[12:6]} + {1'b0, b_i[12:6]} + {{7{1'b0}}, 1'b1};
assign blk_4 = carry_3 ? blk_4_1 : blk_4_0;
assign sum[12:6] = blk_4[6:0];
wire carry_4;
assign carry_4 = blk_4[7];

wire [1:0] blk_5_0;
wire [1:0] blk_5_1;
wire [1:0] blk_5;
assign blk_5_0 = {1'b0, a_i[13:13]} + {1'b0, b_i[13:13]};
assign blk_5_1 = {1'b0, a_i[13:13]} + {1'b0, b_i[13:13]} + {{1{1'b0}}, 1'b1};
assign blk_5 = carry_4 ? blk_5_1 : blk_5_0;
assign sum[13:13] = blk_5[0:0];
wire carry_5;
