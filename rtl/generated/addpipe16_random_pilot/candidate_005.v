...
wire [3:0] blk_2_1;
wire [3:0] blk_2;
assign blk_2_0 = {1'b0, a_i[6:4]} + {1'b0, b_i[6:4]};
assign blk_2_1 = {1'b0, a_i[6:4]} + {1'b0, b_i[6:4]} + {{3{1'b0}}, 1'b1};
assign blk_2 = carry_1 ? blk_2_1 : blk_2_0;
assign sum[6:4] = blk_2[2:0];
wire carry_2;
...
wire [4:0] blk_4_1;
wire [4:0] blk_4;
assign blk_4_0 = {1'b0, a_i[11:8]} + {1'b0, b_i[11:8]};
assign blk_4_1 = {1'b0, a_i[11:8]} + {1'b0, b_i[11:8]} + {{4{1'b0}}, 1'b1};
assign blk_4 = carry_3 ? blk_4_1 : blk_4_0;
assign sum[11:8] = blk_4[3:0];
wire carry_4;
...
wire [2:0] blk_6_1;
wire [2:0] blk_6;
assign blk_6_0 = {1'b0, a_i[14:13]} + {1'b0, b_i[14:13]};
assign blk_6_1 = {1'b0, a_i[14:13]} + {1'b0, b_i[14:13]} + {{2{1'b0}}, 1'b1};
assign blk_6 = carry_5 ? blk_6_1 : blk_6_0;
assign sum[14:13] = blk_6[1:0];
wire carry_6;
