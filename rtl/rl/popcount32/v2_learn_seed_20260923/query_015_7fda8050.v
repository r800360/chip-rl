...
wire [5:0] pc_1 = 6'd0 + {5'd0, a_i[5]} + {5'd0, a_i[6]};
wire [5:0] pc_2 = 6'd0 + {5'd0, a_i[7]} + {5'd0, a_i[8]} + {5'd0, a_i[9]} + {5'd0, a_i[10]} + {5'd0, a_i[11]} + {5'd0, a_i[12]} + {5'd0, a_i[13]} + {5'd0, a_i[14]} + {5'd0, a_i[15]};
wire [5:0] pc_3 = 6'd0 + {5'd0, a_i[16]} + {5'd0, a_i[17]};
wire [5:0] pc_4 = 6'd0 + {5'd0, a_i[18]} + {5'd0, a_i[19]};
wire [5:0] pc_5 = 6'd0 + {5'd0, a_i[20]};
wire [5:0] pc_6 = 6'd0 + {5'd0, a_i[21]} + {5'd0, a_i[22]};
