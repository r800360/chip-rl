...
wire [5:0] pc_2 = 6'd0 + {5'd0, a_i[4]} + {5'd0, a_i[5]};
wire [5:0] pc_3 = 6'd0 + {5'd0, a_i[6]} + {5'd0, a_i[7]};
wire [5:0] pc_4 = 6'd0 + {5'd0, a_i[8]};
wire [5:0] pc_5 = 6'd0 + {5'd0, a_i[9]};
wire [5:0] pc_6 = 6'd0 + {5'd0, a_i[10]};
wire [5:0] pc_7 = 6'd0 + {5'd0, a_i[11]};
wire [5:0] pc_8 = 6'd0 + {5'd0, a_i[12]};
wire [5:0] pc_9 = 6'd0 + {5'd0, a_i[13]};
wire [5:0] pc_10 = 6'd0 + {5'd0, a_i[14]};
wire [5:0] pc_11 = 6'd0 + {5'd0, a_i[15]};
wire [5:0] pc_12 = 6'd0 + {5'd0, a_i[16]};
wire [5:0] pc_13 = 6'd0 + {5'd0, a_i[17]};
wire [5:0] pc_14 = 6'd0 + {5'd0, a_i[18]};
wire [5:0] pc_15 = 6'd0 + {5'd0, a_i[19]};
wire [5:0] pc_16 = 6'd0 + {5'd0, a_i[20]};
wire [5:0] pc_17 = 6'd0 + {5'd0, a_i[21]};
wire [5:0] pc_18 = 6'd0 + {5'd0, a_i[22]};
wire [5:0] pc_19 = 6'd0 + {5'd0, a_i[23]};
wire [5:0] pc_20 = 6'd0 + {5'd0, a_i[24]};
wire [5:0] pc_21 = 6'd0 + {5'd0, a_i[25]};
wire [5:0] pc_22 = 6'd0 + {5'd0, a_i[26]};
wire [5:0] pc_23 = 6'd0 + {5'd0, a_i[27]};
wire [5:0] pc_24 = 6'd0 + {5'd0, a_i[28]};
wire [5:0] pc_25 = 6'd0 + {5'd0, a_i[29]};
wire [5:0] pc_26 = 6'd0 + {5'd0, a_i[30]};
wire [5:0] pc_27 = 6'd0 + {5'd0, a_i[31]};
