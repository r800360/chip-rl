...
wire [5:0] blk_3_1;
wire [5:0] blk_3;
assign blk_3_0 = {1'b0, a_i[11:7]} + {1'b0, b_i[11:7]};
assign blk_3_1 = {1'b0, a_i[11:7]} + {1'b0, b_i[11:7]} + {{5{1'b0}}, 1'b1};
assign blk_3 = carry_2 ? blk_3_1 : blk_3_0;
assign sum[11:7] = blk_3[4:0];
wire carry_3;
...
wire [2:0] blk_4_1;
wire [2:0] blk_4;
assign blk_4_0 = {1'b0, a_i[13:12]} + {1'b0, b_i[13:12]};
assign blk_4_1 = {1'b0, a_i[13:12]} + {1'b0, b_i[13:12]} + {{2{1'b0}}, 1'b1};
assign blk_4 = carry_3 ? blk_4_1 : blk_4_0;
assign sum[13:12] = blk_4[1:0];
wire carry_4;
