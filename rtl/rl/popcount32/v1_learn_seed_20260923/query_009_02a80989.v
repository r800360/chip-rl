...
wire [5:0] pc_5 = 6'd0 + {5'd0, a_i[12]} + {5'd0, a_i[13]} + {5'd0, a_i[14]} + {5'd0, a_i[15]} + {5'd0, a_i[16]} + {5'd0, a_i[17]} + {5'd0, a_i[18]} + {5'd0, a_i[19]};
...
wire [5:0] pc_9 = 6'd0 + {5'd0, a_i[26]} + {5'd0, a_i[27]} + {5'd0, a_i[28]} + {5'd0, a_i[29]} + {5'd0, a_i[30]} + {5'd0, a_i[31]};
