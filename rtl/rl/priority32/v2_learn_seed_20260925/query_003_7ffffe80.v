...
wire hit_0 = |a_i[7:0];
wire [4:0] idx_0 = a_i[7] ? 5'd7 : a_i[6] ? 5'd6 : a_i[5] ? 5'd5 : a_i[4] ? 5'd4 : a_i[3] ? 5'd3 : a_i[2] ? 5'd2 : a_i[1] ? 5'd1 : a_i[0] ? 5'd0 : 5'd0;
wire hit_1 = |a_i[9:8];
wire [4:0] idx_1 = a_i[9] ? 5'd9 : a_i[8] ? 5'd8 : 5'd0;
wire hit_2 = |a_i[10];
wire [4:0] idx_2 = a_i[10] ? 5'd10 : 5'd0;
wire hit_3 = |a_i[11];
wire [4:0] idx_3 = a_i[11] ? 5'd11 : 5'd0;
wire hit_4 = |a_i[12];
wire [4:0] idx_4 = a_i[12] ? 5'd12 : 5'd0;
wire hit_5 = |a_i[13];
wire [4:0] idx_5 = a_i[13] ? 5'd13 : 5'd0;
wire hit_6 = |a_i[14];
wire [4:0] idx_6 = a_i[14] ? 5'd14 : 5'd0;
wire hit_7 = |a_i[15];
wire [4:0] idx_7 = a_i[15] ? 5'd15 : 5'd0;
wire hit_8 = |a_i[16];
wire [4:0] idx_8 = a_i[16] ? 5'd16 : 5'd0;
wire hit_9 = |a_i[17];
wire [4:0] idx_9 = a_i[17] ? 5'd17 : 5'd0;
wire hit_10 = |a_i[18];
wire [4:0] idx_10 = a_i[18] ? 5'd18 : 5'd0;
wire hit_11 = |a_i[19];
wire [4:0] idx_11 = a_i[19] ? 5'd19 : 5'd0;
wire hit_12 = |a_i[20];
wire [4:0] idx_12 = a_i[20] ? 5'd20 : 5'd0;
wire hit_13 = |a_i[21];
wire [4:0] idx_13 = a_i[21] ? 5'd21 : 5'd0;
wire hit_14 = |a_i[22];
wire [4:0] idx_14 = a_i[22] ? 5'd22 : 5'd0;
wire hit_15 = |a_i[23];
wire [4:0] idx_15 = a_i[23] ? 5'd23 : 5'd0;
wire hit_16 = |a_i[24];
wire [4:0] idx_16 = a_i[24] ? 5'd24 : 5'd0;
wire hit_17 = |a_i[25];
wire [4:0] idx_17 = a_i[25] ? 5'd25 : 5'd0;
wire hit_18 = |a_i[26];
wire [4:0] idx_18 = a_i[26] ? 5'd26 : 5'd0;
wire hit_19 = |a_i[27];
wire [4:0] idx_19 = a_i[27] ? 5'd27 : 5'd0;
wire hit_20 = |a_i[28];
wire [4:0] idx_20 = a_i[28] ? 5'd28 : 5'd0;
wire hit_21 = |a_i[29];
wire [4:0] idx_21 = a_i[29] ? 5'd29 : 5'd0;
wire hit_22 = |a_i[30];
wire [4:0] idx_22 = a_i[30] ? 5'd30 : 5'd0;
wire hit_23 = |a_i[31];
wire [4:0] idx_23 = a_i[31] ? 5'd31 : 5'd0;
