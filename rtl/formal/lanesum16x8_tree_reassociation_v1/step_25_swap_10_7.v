...
wire [10:0] s_001f = {1'd0,s_000f} + {3'd0,lane_4};
wire [10:0] s_003f = s_001f + {3'd0,lane_5};
wire [10:0] s_013f = s_003f + {3'd0,lane_8};
wire [10:0] s_017f = s_013f + {3'd0,lane_6};
wire [11:0] s_037f = {1'd0,s_017f} + {4'd0,lane_9};
wire [11:0] s_03ff = s_037f + {4'd0,lane_7};
wire [11:0] s_07ff = s_03ff + {4'd0,lane_10};
wire [11:0] s_0fff = s_07ff + {4'd0,lane_11};
